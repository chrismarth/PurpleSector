...
export default function CreateRunPlanPage() {
  ...
  function updateSession(index: number, field: keyof PlannedSession, value: string) {
    ...
    // Auto-generate session name if not manually edited
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>
                  Pre-configure multiple sessions for this event
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <Card className="bg-muted/50">
              <CardHeader>
                ...
                <CardDescription>
                  These settings will apply to all sessions in this run plan
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Global Telemetry Source */}
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => {
                      ...
                      // Reset all session configurations when vehicle changes
