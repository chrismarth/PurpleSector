...
export default function VehicleSetupNewPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    try { await createSetupMutation.mutateAsync(); router.visit(`/vehicle/${vehicleId}`); }
    catch (error) { console.error('Error creating setup:', error); alert('Failed to create setup'); }
  }
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription>Define setup parameters for this vehicle</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">Link this setup to a specific configuration</p>
              </div>
              <div className="space-y-3">
                ...
                <p className="text-sm text-muted-foreground">Add parameters like Ride Height, Weight Distribution, Tire Pressure, etc.</p>
              </div>
              <input ref={fileInputRef} type="file" accept=".csv" onChange={handleFileUpload} className="hidden" />
              <div className="flex gap-4 pt-4">
                <Button type="submit" disabled={loading} className="flex-1">{loading ? 'Creating...' : 'Create Setup'}</Button>
        ...
        <Dialog open={showImportDialog} onOpenChange={setShowImportDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>This feature is coming soon. You'll be able to import setup files directly from {importType === 'ac' ? 'Assetto Corsa' : 'ACC'}.</DialogDescription>
            </DialogHeader>
