...
export default function VehicleConfigurationDetailPage() {
  ...
  const configurationQuery = useQuery({
    ...
    queryFn: async (): Promise<VehicleConfiguration> => {
      return fetchJson<VehicleConfiguration>(`/api/vehicles/${vehicleId}/configurations/${configId}`, {
  ...
  async function handleDelete() {
    ...
    try { await deleteConfigurationMutation.mutateAsync(); router.visit(`/vehicle/${vehicleId}`); }
    catch (error) { console.error('Error deleting configuration:', error); alert('Failed to delete configuration'); }
  }
          ...
          <CardHeader>
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <CardDescription>Configuration for {configuration.vehicle.name}</CardDescription>
              </div>
