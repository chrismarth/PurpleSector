...
interface VehicleSetup { id: string; name: string; vehicleConfiguration: { name: string } | null; }

export default function SessionNewPage() {
  const { eventId } = usePage().props as unknown as { eventId: string };
  ...
  const createSessionMutation = useMutation({
    mutationFn: async () => {
      if (!name || !source || !eventId) throw new Error('Missing required fields');
    ...
    onSuccess: async (session) => {
      ...
      if (eventId) expandNode(`event:${eventId}`);
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Set up a new telemetry analysis session</p>
            </div>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Give your session a descriptive name</CardDescription>
            </CardHeader>
            <CardContent>
              <Input
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Choose where to get telemetry data from</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select a vehicle, configuration, and setup for this session</CardDescription>
            </CardHeader>
