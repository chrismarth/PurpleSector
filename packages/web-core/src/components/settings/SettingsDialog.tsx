...
const DEFAULT_AVATARS = [
  { id: 'helmet-red', src: '/static/images/avatars/helmet-red.svg', label: 'Red Helmet' },
  { id: 'helmet-blue', src: '/static/images/avatars/helmet-blue.svg', label: 'Blue Helmet' },
  { id: 'helmet-green', src: '/static/images/avatars/helmet-green.svg', label: 'Green Helmet' },
  { id: 'helmet-purple', src: '/static/images/avatars/helmet-purple.svg', label: 'Purple Helmet' },
  { id: 'helmet-orange', src: '/static/images/avatars/helmet-orange.svg', label: 'Orange Helmet' },
  { id: 'helmet-yellow', src: '/static/images/avatars/helmet-yellow.svg', label: 'Yellow Helmet' },
  { id: 'helmet-white', src: '/static/images/avatars/helmet-white.svg', label: 'White Helmet' },
  { id: 'helmet-black', src: '/static/images/avatars/helmet-black.svg', label: 'Black Helmet' },
];
                    ...
                    <div className="space-y-2">
                      ...
                      {versionInfo ? (
                        <div className="text-sm text-muted-foreground space-y-1">
                          ...
                          <div>
                            Runtime: {versionInfo.runtime.env === 'python' ? 'Python' : `Node ${versionInfo.runtime.node}`} ({versionInfo.runtime.env})
                          </div>
                        </div>
                      ) : (
                        <div className="text-sm text-muted-foreground">Loading...</div>
