...
export function TelemetryDataPanel({
  ...
  return (
    <Card className={isFullscreen ? 'fixed inset-0 z-50 rounded-none flex flex-col' : 'flex flex-col h-full'}>
      ...
      <CardContent className={isFullscreen ? 'flex-1 min-h-0 overflow-hidden pt-4' : 'flex-1 flex flex-col pt-4'}>
        <AnalysisPanelGrid
          context={context}
          telemetry={telemetry}
